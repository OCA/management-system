...
class MgmtsystemAction(models.Model):
    ...
    def _compute_mgmtsystem_claim_count(self):
        for mgmtsystem_action in self:
            mgmtsystem_action.mgmtsystem_claim_count = len(mgmtsystem_action.mgmtsystem_claim_ids)
    
    mgmtsystem_claim_ids = fields.Many2many('mgmtsystem.claim','mgmtsystem_action_mgmtsystem_claim_rel','mgmtsystem_action_id','mgmtsystem_claim_id','Claim Ids')
...
class MgmtsystemClaim(models.Model):
    ...
    def _compute_mgmtsystem_action_count(self):
        for mgmtsystem_claim in self:
            mgmtsystem_claim.mgmtsystem_action_count = len(mgmtsystem_claim.mgmtsystem_action_ids)
