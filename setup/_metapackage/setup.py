...
setuptools.setup(
    ...
    install_requires=[
        ...
        'odoo-addon-mgmtsystem_evaluation>=16.0dev,<16.1dev',
        'odoo-addon-mgmtsystem_evaluation_hr>=16.0dev,<16.1dev',
        ...
        'odoo-addon-mgmtsystem_nonconformity_maintenance>=16.0dev,<16.1dev',
        ...
        'odoo-addon-mgmtsystem_review_survey>=16.0dev,<16.1dev',
