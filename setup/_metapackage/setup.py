...
setuptools.setup(
    ...
    install_requires=[
        ...
        'odoo11-addon-mgmtsystem_action_efficacy',
        'odoo11-addon-mgmtsystem_action_template',
        ...
        'odoo11-addon-mgmtsystem_nonconformity_mrp',
        'odoo11-addon-mgmtsystem_nonconformity_product',
        'odoo11-addon-mgmtsystem_nonconformity_type',
        'odoo11-addon-mgmtsystem_partner',
