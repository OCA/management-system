...
class TestModelEvent(common.TransactionCase):
    @classmethod
    def setUpClass(cls):
        super().setUpClass()
        cls.nc_model = cls.env["mgmtsystem.event"]
    ...
    def test_reset_kanban_state(self):
        ...
        self.nc_test.stage_id = self.env.ref("mgmtsystem_event.stage_analysis")
    ...
    def test_open_validation(self):
        ...
        open_stage = self.env.ref("mgmtsystem_event.stage_open")
    ...
    def test_done_validation(self):
        ...
        done_stage = self.env.ref("mgmtsystem_event.stage_done")
